...
const DragEditItem = _ref => {
  ...
  const currentHour = useSharedValue(event.top / timeIntervalHeight.value + start);
  ...
  }, renderEventContent ? renderEventContent(event, timeIntervalHeight) : _renderEventContent(), /*#__PURE__*/React.createElement(GestureDetector, {
