...
const Timeline = (_ref, ref) => {
  ...
  }), [goToNextPage, goToPrevPage, updateCurrentDate, viewMode, tzOffset, firstDate, totalPages, timelineHorizontalListRef, timeIntervalHeight, spaceFromTop, timelineLayoutRef, goToOffsetY, offsetY.value, currentIndex.value, initialTimeIntervalHeight, minTimeIntervalHeight.value, maxTimeIntervalHeight, timelineVerticalListRef]);
