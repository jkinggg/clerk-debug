...
const TimelinePage = _ref => {
  ...
  const _onPressBackgroundHandler = (type, event) => {
    ...
    const dateIsoString = (0, _utils.convertPositionToISOString)(event.nativeEvent.locationX, event.nativeEvent.locationY, startDate, timeIntervalHeight.value, columnWidth);
    switch (type) {
      case 'longPress':
